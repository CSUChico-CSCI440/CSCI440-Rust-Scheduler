...
```bash
~$ wget [https://github.com/CSUChico-CSCI340/CSCI440-Scheduler/archive/refs/heads/main.zip](https://github.com/CSUChico-CSCI440/CSCI440-Rust-Scheduler/archive/refs/heads/main.zip)
~$ unzip main.zip
